...
export const Search = ({ value, onChange, onClear }: SearchProps) => {
	return (
		<form className={s['search']}>
			...
			/>
			{value.length > 0 && (
				<button className={s['search__btn']} onClick={onClear}>
					<svg
						width='24'
						height='24'
						viewBox='0 0 24 24'
						...
						<path
							fillRule='evenodd'
							clipRule='evenodd'
							d='M12 20C16.3765 20 20 16.3765 20 12C20 7.63137 16.3686 4 11.9922 4C7.62353 4 4 7.63137 4 12C4 16.3765 7.63137 20 12 20Z'></path>
						<path
							fillRule='evenodd'
							clipRule='evenodd'
